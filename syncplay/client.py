...
class SyncplayClient(object):
    def __init__(self, playerClass, ui, config):
        ...
        if config['password']:
            config['password'] = hashlib.md5(str(config['password']).encode('utf-8')).hexdigest()
...
class SyncplayUserlist(object):
    ...
    def getFileDifferencesForRoom(self):
        ...
        for otherUser in list(self._users.values()):
        ...
        with self.lock:
            try:
                ...
                if dirsToSearch:
                    ...
                    randomFilename = u"RandomFile"+str(random.randrange(10000, 99999))+u".txt"
